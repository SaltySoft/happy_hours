...
], function ($, _, Backbone, MainViewTemplate, CocktailListView, CocktailFeaturedView, CocktailDetailsView, CocktailCreationView, CocktailSearchView, User) {
        ...
        init: function (app) {
            ...
            var AppRouter = Backbone.Router.extend({
                ...
                featured_cocktail: function () {
                    base.$el.find("#sub_app_container").fadeOut(500, function () {
                        ...
                        base.$el.find("#sub_app_container").fadeIn(500);
                    });
